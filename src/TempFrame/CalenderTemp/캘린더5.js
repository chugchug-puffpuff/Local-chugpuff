        ...
        <div className="frame-2">
          ...
          <div className="frame-3">
              ...
              <div className="frame-6">
                ...
                <div className="line-4">
                  ...
                  <div className="frame-7">
                    ...
                    />
                    <div className="frame-8">
                      <div className="text-wrapper-4">자소서 제출ㅇㄹ ㅁㄴㄹㅇㅁㄴㅇㄹ</div>
            ...
            <div className="frame-10">
              <div className="text-wrapper-5">일정 추가</div>
            </div>
          </div>
        </div>
      </div>
      <p className="p">📆 치치폭폭으로 관리하는 취업 일정</p>
      <div className="view">
        <div className="view-2">
          <div className="navbar">
            <div className="text-wrapper-6">AI 모의면접</div>
            <div className="text-wrapper-6">자기소개서 첨삭</div>
            <div className="text-wrapper-6">취업공고</div>
            <div className="text-wrapper-6">커뮤니티</div>
            <div className="text-wrapper-6">캘린더</div>
          </div>
          ...
          <div className="frame-wrapper">
            <div className="frame-11">
              <p className="div-2">
                ...
                <span className="text-wrapper-7"> 님</span>
              </p>
              <img
                className="img"
                alt="Arrow drop down"
